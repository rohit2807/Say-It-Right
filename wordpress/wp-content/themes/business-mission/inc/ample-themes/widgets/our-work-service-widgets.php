...
if (!class_exists('business_epic_Our_Work_Widget')) {
    class business_epic_Our_Work_Widget extends WP_Widget
    {
        ...
        private function defaults()
        {
            ...
            $defaults = array(
                'title' => esc_html__('Our Work', 'business-mission'),
                'sub-title' => esc_html__('sub title', 'business-mission'),
                'business_epic_portfolio_filter_all' => esc_html__('All', 'business-mission'),
                'cat_id' => array(),
        ...
        {
            parent::__construct(
                'business-mission-our-work-widget',
                esc_html__('Business Our Work Widget', 'business-mission'),
                array('description' => esc_html__('Business Work Section', 'business-mission'))
            );
        }
        ...
        public function form($instance)
        {
            ...
            <p>
                <label
                    for="<?php echo esc_attr($this->get_field_id('title')); ?>"><strong><?php esc_html_e('Title:', 'business-mission'); ?></strong></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id('sub-title') ); ?>">
                    <?php esc_html_e( 'Sub Title', 'business-mission'); ?>
                </label><br/>
            ...
            <p>
                <label
                    for="<?php echo esc_attr($this->get_field_id('business_epic_portfolio_filter_all')); ?>"><strong><?php esc_html_e('Our Work Filter All Text', 'business-mission'); ?></strong></label>
                <input class="widefat"
            ...
            <p>
                <label
                    for="<?php echo esc_attr($this->get_field_id('cat_id')); ?>"><strong><?php esc_html_e('Select Category', 'business-mission'); ?></strong></label>
