 ...
 * @return void
 */
function arya_multipurpose_woocommerce_setup() {
	add_theme_support( 'woocommerce' );
	add_theme_support( 'wc-product-gallery-zoom' );
	add_theme_support( 'wc-product-gallery-lightbox' );
	add_theme_support( 'wc-product-gallery-slider' );
}
add_action( 'after_setup_theme', 'arya_multipurpose_woocommerce_setup' );
 ...
 * @return void
 */
function arya_multipurpose_woocommerce_scripts() {
	// wp_enqueue_style( 'arya-multipurpose-woocommerce-style', get_template_directory_uri() . '/woocommerce.css' );
	...
	wp_add_inline_style( 'arya-multipurpose-woocommerce-style', $inline_font );
}
add_action( 'wp_enqueue_scripts', 'arya_multipurpose_woocommerce_scripts' );
 ...
 */
function arya_multipurpose_woocommerce_active_body_class( $classes ) {
	$classes[] = 'woocommerce-active';

	return $classes;
}
add_filter( 'body_class', 'arya_multipurpose_woocommerce_active_body_class' );
 ...
 */
function arya_multipurpose_woocommerce_products_per_page() {
	return 12;
}
add_filter( 'loop_shop_per_page', 'arya_multipurpose_woocommerce_products_per_page' );
 ...
 */
function arya_multipurpose_woocommerce_thumbnail_columns() {
	return 4;
}
add_filter( 'woocommerce_product_thumbnails_columns', 'arya_multipurpose_woocommerce_thumbnail_columns' );
