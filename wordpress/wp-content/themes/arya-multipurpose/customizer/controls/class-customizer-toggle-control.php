...
class Arya_Multipurpose_Customizer_Toggle_Control extends WP_Customize_Control {
	...
	public function render_content() {
		...
		<label>
			<div style="display:flex;flex-direction: row;justify-content: flex-start;">
				<span class="customize-control-title toggle-control-title" style="flex: 2 0 0; vertical-align: middle;"><?php echo esc_html( $this->label ); ?></span>
