        ...
        <div class="cart-body" >
            ...
            <div class="cart-box">
                <div class="customer-details">
                    <form action="" method="POST" id="cust-form"  >
                        
                        <div class="cust-form-head">Contact Information</div>
                        <input class="cust-input" type="email" placeholder="Enter Email" name="email"></input>       
                        ...
                        <div class="cust-input-half">
                            ...
                            <input type="text" placeholder="Enter Last Name" class="secnd" name="lname"></input>
                        </div>
                        <input class="cust-input" type="text" placeholder="Enter Address" name="address"></input>
                        <input class="cust-input" type="text" placeholder="Enter Apartment, suite, etc." name="apt"></input>
                        <input class="cust-input" type="text" placeholder="Enter City" name="city"></input>
                        <div>
                            <select name="language" id="cust-lang">
                                <option selected="selected">English</option>
                            </select> 
                            <input type="text" placeholder="Enter Postal Code" class="cust-zcode" name="postal"></input>
                        </div>
