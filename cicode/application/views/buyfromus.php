...
<!--		</div>-->
		...
		<div id="bfu-mybody">	
                    ...
                    <form action="" method="POST" id="myForm" onsubmit="return validateItem();">
                        ...
                        <div class="popup-data">
                            <div class="product-quantity">
                                ...
                                <input type="hidden" id="c_id" name="c_id"></input>
                        ...
                        <div class="button-bfupop">
                            <input type="submit" value="Add to Cart" class="button-bfupop add-bfu" name="add_cart"></input>
			...
			<script>
		function rdrct_page() {
			location.replace("buyfromus_popup.php")
		}
	</script>
