...
<!--		</div>-->
		...
		<div class="contact-block">
		    <form id="createMessage" action="<?php echo base_url().'contact/contact_validation'; ?>"" method="POST" novalidate>
		                <?php
                        ...
                        ?>
    			<div class="c-details">
    				<input type="text" placeholder="Enter your name" class="cfields" name="c_fname" required="required" value="<?php echo set_value('c_fname'); ?>"/>
    				<input type="text" placeholder="Enter Last name" class="cfields" name="c_lname" required="required" value="<?php echo set_value('c_lname'); ?>"/>
    				<input type="text" placeholder="Telephone" class="cfields" name="c_phone" required="required" value="<?php echo set_value('c_phone'); ?>"/>
    			</div>
    			<div class="c-message">
    				<textarea placeholder="Enter Message" name="c_message" required="required" value="<?php echo set_value('c_message'); ?>"></textarea>
    			</div>
